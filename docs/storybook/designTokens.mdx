...
<div className={[style.admonition, style.warning].join(' ')}>
  **⚠️** Component-specific tokens are not used in the Bio4C Design System. See
  [SBB](https://wiki.merckgroup.com/confluence/display/PAD/SBB+-+Design+tokens#SBBDesigntokens-Whataboutcomponent-specifictokens?)
  to find out more.
</div>
...
* [[Confluence] Bio4C Design System / SBB - Design tokens](https://wiki.merckgroup.com/confluence/display/PAD/SBB+-+Design+tokens)
...
* [[Figma] Bio4C Design System / Fundamentals / Typography](https://www.figma.com/file/Svp4Vqs9rU5iJViXL3ARfC/%5BDS%5D-Fundamentals-v0.1.0?type=design&node-id=825-16136&mode=design&t=jqOuhF1N6LV984M4-0)
* [[Figma] Bio4C Design System / Fundamentals / Spacing](https://www.figma.com/file/Svp4Vqs9rU5iJViXL3ARfC/%5BDS%5D-Fundamentals-v0.1.0?type=design&node-id=394-46449&mode=design&t=jqOuhF1N6LV984M4-0)
* [[Figma] Bio4C Design System / Fundamentals / Borders & Radius](https://www.figma.com/file/Svp4Vqs9rU5iJViXL3ARfC/%5BDS%5D-Fundamentals-v0.1.0?type=design&node-id=57-600&mode=design&t=jqOuhF1N6LV984M4-0)
* [[Figma] Bio4C Design System / Fundamentals / Shadows](https://www.figma.com/file/Svp4Vqs9rU5iJViXL3ARfC/%5BDS%5D-Fundamentals-v0.1.0?type=design&node-id=57-597&mode=design&t=jqOuhF1N6LV984M4-0)
