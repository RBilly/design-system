...
Please note that react and react-dom are peer dependencies, meaning you should ensure they are installed before installing Bio4c UI-Kit.
...
<Source dark language="tsx" code={`
  import '@bio4c/ui-kit/index.css';
`}/>

Then you can use any component of this library anywhere by importing it from the lib.

<Source dark language="tsx" code={`
  import { Button, CheckCircleIcon } from '@bio4c/ui-kit';
`}/>

# Noto Font

In order to support internationalization of your application, Bio4c UI-Kit expect your project to use the [Noto fonts](https://fonts.google.com/noto/specimen/Noto+Sans). \
...
Fontsource can be configured to load specific subsets, weights and styles. Default typography configuration of Bio4C Design System relies only on the 400, 500 and 600 font weights.
